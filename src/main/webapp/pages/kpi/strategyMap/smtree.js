Ext.define('Ext.kpi.strategyMap.smtree', {
    ...
    smDeleteHandler: function (id, type) {
    	var me = this;
        Ext.MessageBox.show({
    ...
    initComponent: function () {
        var me = this;
        //me.editurl = __ctxPath + "/pages/kpi/strategyMap/smmgredit.jsp?";
