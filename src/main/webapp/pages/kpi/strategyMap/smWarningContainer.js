 ...
 * @author 陈晓哲
 */
Ext.define('Ext.kpi.strategyMap.smWarningContainer', {
    ...
    _addListerner:function(){
        ...
        me.grid.on('selectionchange', function(){
        	if(me.grid.down('#sm_delBtn')){
        		me.grid.down('#sm_delBtn').setDisabled(me.grid.getSelectionModel().getSelection().length === 0);
        	}
        }); //选择记录发生改变时改变按钮可用状态
