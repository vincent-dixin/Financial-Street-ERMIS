			...
			Ext.onReady(function(){
				...
				tabPanel = new Ext.TabPanel({
			        ...
			        items:[
						{
						    title: '工作流日志',
						    html:"<iframe src='${ctx}/jbpm/processInstance/processInstanceInfoShow.do?id=${jbpmHistProcinst.id}&processId=${processInstanceId}' scrolling='yes' frameBorder='0' height='100%' width='100%'></iframe>"
						},{
						    title: '工作流状态',
