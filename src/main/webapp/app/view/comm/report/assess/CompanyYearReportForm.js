    ...
    onSave : function(){
    	...
    	if(me.form.isValid()) {
    		FHD.submit({
				...
				url : __ctxPath + '/comm/report/saveCompanyYearReport.f?reportType=company_year_assessment_report',
    ...
    onSubmit : function() {
    	...
    	if(me.form.isValid()) {
    		FHD.submit({
				...
				url : __ctxPath + '/comm/report/savecompanyyearreportsubmit.f?reportType=company_year_assessment_report',
				callback: function (data) {
					var centerpanel = me.up('panel');
			    	centerpanel.removeAll();
					centerpanel.add(Ext.widget('companyyearreportlist'));
