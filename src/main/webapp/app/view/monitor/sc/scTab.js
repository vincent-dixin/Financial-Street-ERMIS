...
Ext.define('FHD.view.monitor.sc.scTab', {
    extend: 'Ext.tab.Panel',

    requires: [
        'FHD.view.monitor.sc.scKpiGrid',
    ...
    initComponent: function() {
        var me = this;
        //度量标准页签
        if(!me.scorecardkpigrid){
        	me.scorecardkpigrid = Ext.create('FHD.view.monitor.sc.scKpiGrid',{id:'scorecardkpigrid',monitorContainer:me.monitorContainer});
        }
        //图表分析页签
