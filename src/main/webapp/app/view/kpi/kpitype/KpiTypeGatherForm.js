Ext.define('FHD.view.kpi.kpitype.KpiTypeGatherForm', {
    extend: 'Ext.form.Panel',
    alias: 'widget.kpitypegatherform',
    ...
    clearFormData:function(){
    	var me = this;
    	me.getForm().reset();
    	var resultgatherfrequence = Ext.getCmp('kpi_type_resultgatherfrequence' );
        var targetSetFrequence = Ext.getCmp('kpi_type_targetSetFrequence' );
        var reportFrequence = Ext.getCmp('kpi_type_reportFrequence' );
        var targetSetReportFrequence = Ext.getCmp('kpi_type_targetSetReportFrequence' );
    ...
    initFormData:function(){
    	var me = this;
    	//添加时,需要添加评估值的默认公式
    	Ext.getCmp('kpi_type_kpitypeassessmentFormulaSelector' ).setTriggerValue("IF(#[myself~实际值]>=#[myself~目标值],100,#[myself~实际值]/#[myself~目标值]*100)");
        Ext.getCmp('kpi_type_kpitypeassessmentFormulaSelector' ).setRadioValue("0sys_use_formular_formula");
        
        Ext.getCmp('kpi_type_kpityperesultFormulaSelector' ).setRadioValue("0sys_use_formular_manual");
        Ext.getCmp('kpi_type_kpitypetargetFormulaSelector' ).setRadioValue("0sys_use_formular_manual");
//        Ext.getCmp('kpi_type_kpityperelationFormulaSelector' ).setRadioValue("0sys_use_formular_manual");
//        Ext.getCmp('kpi_type_kpitypealarmFormulaSelector' ).setRadioValue("0sys_use_formular_manual");
        //设置采集频率默认值为按月采集
        var resultgatherfrequence = Ext.getCmp('kpi_type_resultgatherfrequence' );
    ...
    last: function (cardPanel, finishflag) {
        ...
        var resultformulaDict = Ext.getCmp('kpi_type_kpityperesultFormulaSelector').getRadioValue();
        var resultformula = Ext.getCmp('kpi_type_kpityperesultFormulaSelector' ).getTriggerValue();
        var targetformulaDict = Ext.getCmp('kpi_type_kpitypetargetFormulaSelector' ).getRadioValue();
        var targetformula = Ext.getCmp('kpi_type_kpitypetargetFormulaSelector' ).getTriggerValue();
        var assessmentformulaDict = Ext.getCmp('kpi_type_kpitypeassessmentFormulaSelector' ).getRadioValue();
        var assessmentformula = Ext.getCmp('kpi_type_kpitypeassessmentFormulaSelector' ).getTriggerValue();
        var resultSumMeasureStr = Ext.getCmp('kpi_type_resultSumMeasure').getValue();
        var targetSumMeasureStr = Ext.getCmp('kpi_type_targetSumMeasure').getValue();
        var assessmentSumMeasureStr = Ext.getCmp('kpi_type_assessmentSumMeasure').getValue();
        var scale = Ext.getCmp('kpi_type_scale').getValue();
        var resultCollectInterval = Ext.getCmp('kpi_type_resultCollectInterval').getValue();
        var targetSetInterval = Ext.getCmp('kpi_type_targetSetInterval').getValue();
        var relativeTo = Ext.getCmp('kpi_type_relativeTo').getValue();
        var modelValue = Ext.getCmp('kpi_type_modelValue').getValue();
        var maxValue = Ext.getCmp('kpitype_maxValue').getValue();
        var minValue = Ext.getCmp('kpitype_minValue').getValue();
        
        jsobj.id = Ext.getCmp('kpitypetab').paramObj.kpitypeid;
	            ...
	            callback: function (data) {
	                if (data && data.success) {
                        ...
                        if (!finishflag) {//如果点击的不是完成按钮,需要移动到下一个面板
                            ...
                            /*同时将告警设置按钮为可用状态*/
                            Ext.getCmp('kpitype_alarmset_btn' ).setDisabled(false);
                            Ext.getCmp('kpitype_alarmset_btn_top').setDisabled(false);
                        }else{
    ...
    addComponent: function () {
        ...
        var resultFormula = Ext.create('FHD.ux.kpi.FormulaSelector', {
            ...
            id: 'kpi_type_kpityperesultFormulaSelector'
        ...
        var targetFormula = Ext.create('FHD.ux.kpi.FormulaSelector', {
            ...
            id: 'kpi_type_kpitypetargetFormulaSelector'
        });
        ...
        var assessmentFormula = Ext.create('FHD.ux.kpi.FormulaSelector', {
            ...
            columnWidth: .5,
            //allowBlank: false,
            id: 'kpi_type_kpitypeassessmentFormulaSelector'
        });
        ...
        var forecastFormula = Ext.create('FHD.ux.kpi.FormulaSelector', {
            ...
            id: 'kpi_type_kpitypealarmFormulaSelector'
        ...
        var relationFormula = Ext.create('FHD.ux.kpi.FormulaSelector', {
            ...
            id: 'kpi_type_kpityperelationFormulaSelector'
        });
        ...
        var assessmentSumMeasure = Ext.create('widget.dictselectforeditgrid', {
            id: 'kpi_type_assessmentSumMeasure',
            editable: false,
            labelWidth: 105,
            labelAlign: 'left',
            multiSelect: false,
        ...
        var c_resultgatherfrequence = Ext.widget('collectionSelector', {
            columnWidth: .5,
            id: 'kpi_type_resultgatherfrequence',
        ...
        var c_targetSetFrequence = Ext.widget('collectionSelector', {
            columnWidth: .5,
            id: 'kpi_type_targetSetFrequence',
        ...
        var c_resultCollectInterval = Ext.widget('numberfield', {
            id: 'kpi_type_resultCollectInterval',
            xtype: 'numberfield',
            step: 1,
            maxValue: 5,
            minValue: 1,
        ...
        var c_targetSetReportFrequence = Ext.widget('collectionSelector', {
            columnWidth: .5,
            id: 'kpi_type_targetSetReportFrequence',
    ...
    valueToFormulaName:function(){
    	var me = this;
    	 var resultformula = Ext.getCmp('kpi_type_kpityperesultFormulaSelector' );
         var targetformula = Ext.getCmp('kpi_type_kpitypetargetFormulaSelector' );
         var assessmentformula = Ext.getCmp('kpi_type_kpitypeassessmentFormulaSelector' );
//         var alarmFormula = Ext.getCmp('kpi_type_kpitypealarmFormulaSelector' );
//         var relationFormula = Ext.getCmp('kpi_type_kpityperelationFormulaSelector' );
         var kpitypetab = Ext.getCmp('kpitypetab');
         var kpitypeid = kpitypetab.paramObj.kpitypeid;
         var kpitypename = kpitypetab.paramObj.kpitypename;
         ...
         //alarmFormula.setTargetId(kpitypeid);
         //alarmFormula.setTargetName(kpitypename);
         //relationFormula.setTargetId(kpitypeid);
         //relationFormula.setTargetName(kpitypename);
    },
