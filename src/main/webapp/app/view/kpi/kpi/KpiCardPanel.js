Ext.define('FHD.view.kpi.kpi.KpiCardPanel', {
    extend: 'FHD.ux.CardPanel',
    alias: 'widget.kpicardpanel',
    
    activeItem: 0,
    backType:'',
    requires: [
               'FHD.view.kpi.kpi.KpiBasicForm',
    ...
    gotopage:function(){
    	...
    	if(me.backType=="sc"){
        	...
        	//刷新度量指标grid
        	scorecardkpigrid.store.proxy.extraParams.id = scorecardtab.paramObj.categoryid;
    		scorecardkpigrid.store.load();
    ...
    */
    ...
    initComponent: function() {
        var me = this;
        me.kpibasicform = Ext.widget('kpibasicform',{id:'kpibasicform'});
