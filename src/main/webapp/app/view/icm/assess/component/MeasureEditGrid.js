...
Ext.define('FHD.view.icm.assess.component.MeasureEditGrid',{
	...
	initComponent:function(){
		...
		me.cols=[
			...
			{header:'控制措施', dataIndex: 'measureName', sortable: false,flex:2,
				renderer:function(value,metaData,record,colIndex,store,view) { 
			...
			{header:'评价结果(Y|N|N/A)', dataIndex: 'assessSampleName',sortable: false,width:120,
				renderer:function(value,metaData,record,colIndex,store,view) { 
			...
			{header:'补充说明', dataIndex: 'adjustDesc',sortable: false,flex:2,editor: {},
				renderer:function(value,metaData,record,colIndex,store,view) { 
					if(value){
