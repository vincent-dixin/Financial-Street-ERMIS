...
Ext.define('FHD.view.icm.icsystem.constructplan.ConstructPlanList',{
    ...
    initComponent: function(){
		...
		if(me.readOnly){
	        ...
	        me.tbarItems = [
	        	{iconCls : 'icon-add',id:'icm_construct_add',text: '添加',tooltip: '建设计划',handler :me.addPlan,scope : this},
				'-', 
				{iconCls : 'icon-edit',id:'icm_construct_edit',text: '修改',tooltip: '建设计划',handler :me.editPlan,scope : this},
				'-', 
				{iconCls : 'icon-del',id:'icm_construct_del',text: '删除',tooltip: '建设计划',handler :me.delPlan,disabled: true,scope : this}
	        ];
		}
        //评价计划列表
        Ext.apply(me,{
