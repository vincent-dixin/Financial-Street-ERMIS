...
//    	me.title='请您选择省份';
//    	me.noteField='code';
//		me.columns = [{dataIndex: 'code',text: '员工编号'},{dataIndex: 'name',text: '员工姓名',isPrimaryName:true}];
 * */

Ext.define('FHD.ux.treelistselector.TreeListSelector', {
	...
	treeEntityName:'NoEntityName',	//后台反射使用
	treeQueryKey:'name',//有column中primaryName指定
	parentKey:'parent.id',
	relationKey:'idSeq',
	entityName:'NoEntityName',	//后台反射使用
	foreignKey:'NoForeignKey',	//点击树列表关联的外键名称
	queryKey:'NoQueryKey',	//列表查询的属性名
	initComponent : function() {
        ...
        me.button=Ext.widget('button',{
            ...
            handler:function(){
				...
				me.window = Ext.create('FHD.ux.treelistselector.TreeListSelectorWindow',{
					title:me.title,
					treeEntityName:me.treeEntityName,
					treeQueryKey:me.treeQueryKey,
