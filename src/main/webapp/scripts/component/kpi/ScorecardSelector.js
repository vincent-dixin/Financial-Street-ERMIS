Ext.define('FHD.ux.kpi.ScorecardSelector', {
	extend : 'Ext.container.Container',
	alias : 'widget.scorecardselector',
	requires:['FHD.ux.kpi.ScorecardSelectorWindow'],
	layout: {
        type: 'column'
    },
        ...
        Ext.applyIf(me, {
            items: [
            	...
            	me.grid,
            	{
                    ...
                    columnWidth: 0.1,
                    handler:function(){
						me.selectorWindow= Ext.create('FHD.ux.kpi.ScorecardSelectorWindow',{
							single:me.single,
							values:me.getValues(),
