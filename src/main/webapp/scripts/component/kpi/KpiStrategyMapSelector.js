Ext.define('FHD.ux.kpi.KpiStrategyMapSelector', {
	extend : 'Ext.container.Container',
	alias : 'widget.kpistrategymapselector',
	requires:['FHD.ux.kpi.KpiStrategyMapSelectorWindow'],
	layout: {
        type: 'column'
    },
            ...
            items: [
            	...
            	me.grid,
            	{
                   ...
                   // iconCls:'icon-kpistrategymap-add',
                    ...
                    columnWidth: 0.1,
                    handler:function(){
						me.selectorWindow= Ext.create('FHD.ux.kpi.KpiStrategyMapSelectorWindow',{
