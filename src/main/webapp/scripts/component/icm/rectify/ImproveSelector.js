Ext.define('FHD.ux.icm.rectify.ImproveSelector',{
	extend :'Ext.form.FieldContainer',
	alias : 'widget.improveselector',
	
	requires:[
		'FHD.ux.icm.rectify.ImproveSelectorWindow'
	],
	...
	initComponent: function() {
		...
		me.btn = Ext.widget('button',{
            ...
            width: 23,
            handler:function(){
				me.selectorWindow= Ext.create('FHD.ux.icm.rectify.ImproveSelectorWindow',{
