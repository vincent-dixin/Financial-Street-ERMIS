Ext.define('FHD.ux.icm.icsystem.ConstructPlanSelector',{
	extend :'Ext.form.FieldContainer',
	alias : 'widget.constructplanselector',
	requires:[
		'FHD.ux.icm.icsystem.ConstructPlanSelectorWindow'
	],
	...
	initComponent: function() {
		...
		me.btn = Ext.widget('button',{
            ...
            width: 23,
            handler:function(){
				me.selectorWindow= Ext.create('FHD.ux.icm.icsystem.ConstructPlanSelectorWindow',{
					multiSelect:me.multiSelect,
					modal: true,
					onSubmit:function(win){
						var constructPlanArray = new Array();
		            	win.selectedGrid.store.each(function(r){
		            		constructPlanArray.push(r);
		            	});
		            	me.setValue(constructPlanArray);
					}
				}).show();
		    }
		});
