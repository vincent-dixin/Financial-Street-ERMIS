Ext.define('FHD.ux.icm.icsystem.ConstructPlanSelectorWindow', {
    extend: 'Ext.window.Window',
	alias: 'widget.constructplanselectorwindow',
    ...
    initComponent: function() {
		...
		me.sourceGrid = Ext.create('FHD.ux.GridPanel', { //实例化一个grid列表
            ...
            flex:1,
            checked:false,
            url: __ctxPath + '/icm/icsystem/constructplan/findconstructplansbypage.f', //调用后台url
            extraParams : {
            	status : 'D'
            },
            cols: [
