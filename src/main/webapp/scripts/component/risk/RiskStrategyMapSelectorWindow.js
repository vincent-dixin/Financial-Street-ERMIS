Ext.define('FHD.ux.risk.RiskStrategyMapSelectorWindow', {
	extend : 'Ext.window.Window',
	alias: 'widget.riskstrategymapSelectorwindow',
	constrain:true,
	height : 500,
	width : 800,
	modal : true,
	...
	title : $locale('riskstrategymapselectorwindow.title'),
...
//	mineSmTreeIcon : 'icon-orgsub',
	...
	initComponent : function() {
		...
		me.tree = Ext.widget('riskstrategymaptree', {
					region : 'west',
					width : 220,
...
//					mineSmTreeIcon : me.mineSmTreeIcon,
		...
		me.grid = Ext.widget('grid', {
			...
			tbar : new Ext.Toolbar({
				...
				items : [{
							xtype : "tbtext",
							text : $locale('risktrategymapselectorwindow.selectgrid.title')
						}, '-']
			}),
