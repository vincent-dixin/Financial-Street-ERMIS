Ext.define('FHD.ux.process.processRelaOrgSelector', {
	extend : 'Ext.container.Container',
	alias : 'widget.processRelaOrgSelector',
	requires : ['FHD.ux.process.processRelaOrgSelectorWindow'],
	layout : {
		type : 'column'
	},
			...
			items : [{
						...
						handler : function() {
							me.selectorWindow = Ext.create(
									'FHD.ux.process.processRelaOrgSelectorWindow', {
