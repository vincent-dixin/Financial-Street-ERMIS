...
//		this.textarea.value = jQuery("#testtable").html();
...
/*			var value = "<table><tr><td id='testtable'>"+this.getCurrentValue()+"</td></tr></table>";
			this.graph.labelChanged(this.editingCell, value, this.trigger);	 
			jQuery("#testtable").css("fontSize",this.textarea.style.fontSize);
			jQuery("#testtable").css("width",this.textarea.style.width);
			jQuery("#testtable").css("textAlign",this.textarea.style.textAlign);
			jQuery("#testtable").css("color",this.textarea.style.color);
			jQuery("#testtable").css("fontWeight",this.textarea.style.fontWeight);
			jQuery("#testtable").css("left",this.textarea.style.left);
			jQuery("#testtable").css("top",this.textarea.style.top);
			jQuery("#testtable").css("height",this.textarea.style.height);
			jQuery("#testtable").css("zIndex",this.textarea.style.zIndex);
			jQuery("#testtable").css("word-break","break-all");
*/
