...
/*	var outline = new mxOutline(graph, outlinePanel.body.dom);
    ...
    insertVertexTemplate(library, graph, '容器', 'images/swimlane.gif', 'swimlane', 200, 200, '容器');//Container
    insertVertexTemplate(library, graph, '矩形', 'images/rectangle.gif', null, 100, 40);
	insertVertexTemplate(library, graph, 'Text', 'images/text.gif', 'text', 70, 70, "Text");
