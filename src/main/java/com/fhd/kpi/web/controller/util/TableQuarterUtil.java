...
//		
//		for (int i = 1; i < 4 + 1; i++) {
//			quarterHtml += getQuarterHtml(String.valueOf(i),
...
//		
//		String html = startTableHtml + YearHtml + quarterHtml + yearSunHtml + endTableHtml;
...
//		quarterHtml.append("<tr>\n");
		...
		quarterHtml.append("<td nowrap='true' align='center' hi='3' id='RT_actual_1'>" + inputReality + "</td>\n");
		quarterHtml.append("<td nowrap='true' align='center' hi='3' id='RT_target_1'>" + inputTarget + "</td>\n");
		quarterHtml.append("<td nowrap='true' align='center' hi='3' id='RT_tolerance_1'>" + inpuAssess + "</td>\n");
